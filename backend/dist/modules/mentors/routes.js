...
router.get("/me", (0, auth_1.requireRole)("MENTOR"), (0, asyncHandler_1.asyncHandler)(controller.myMentorProfile));
router.get("/allocation", (0, auth_1.requireRole)("ADMIN"), (0, asyncHandler_1.asyncHandler)(controller.listAllocationMentors));
router.get("/", (0, auth_1.requireRole)("ADMIN"), (0, asyncHandler_1.asyncHandler)(controller.listMentors));
router.post("/", (0, auth_1.requireRole)("ADMIN"), (0, asyncHandler_1.asyncHandler)(controller.createMentor));
